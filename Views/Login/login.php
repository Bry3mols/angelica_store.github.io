...
<html lang="es">
  <head>
    ...
    <meta name="author" content="Brallelin Angelica">
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <button type="submit" class="btn btn-primary btn-block custom-btn" id="my-button"><i class="fas fa-sign-in-alt"></i> Iniciar sesión</button>
        ...
        <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
          ...
          <h3 class="login-head recuperar-contrasena"><i class="fa fa-lg fa-fw fa-lock"></i>Recuperar Contraseña</h3>
